...
exports.appendTc42Da = void 0;
const color = require("bash-color");
const index_1 = require("../../index");
const drop_table_1 = require("../../utils/drop_table");
const CEARTc5_1 = require("../CEAR/CEARTc5");
const dataMeta = require("../../../../dataStructures.json");
const appendTc42Da = (database, toDrop) => {
    const tc4 = dataMeta.dataStructures.trucostData.table4.table;
    const newTable = "project_table_26";
    ...
    index_1.db.query(sql, (err) => {
        ...
        CEARTc5_1.appendTc52CEAR(database, newTable);
    });
};
exports.appendTc42Da = appendTc42Da;
