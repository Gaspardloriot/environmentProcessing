 ...
 * @returns void
 */
const createTcThree = (tableName, continueCycle = true) => {
    const table = `${tableName}_tc_3`;
    const sql = `CREATE TABLE ${tableName}.${table}${Table_format_1.tc3Format}`;
...
exports.createTcThree = createTcThree;
